...
from LazyDeveloperr import config
...
class Thumbnail:
    def __init__(self):
        ...
        try:
            self.font1 = ImageFont.truetype("LazyDeveloperr/helpers/Raleway-Bold.ttf", 30)
            self.font2 = ImageFont.truetype("LazyDeveloperr/helpers/Inter-Light.ttf", 30)
        except Exception:
