...
from LazyDeveloperr.modules.nightmode import button_row
from LazyDeveloperr import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./LazyDeveloperr/resources/fonts/*")
