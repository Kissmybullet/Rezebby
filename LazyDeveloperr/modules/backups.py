...
# from LazyDeveloperr.modules.sql import warns_sql as warnssql
import LazyDeveloperr.modules.sql.blacklist_sql as blacklistsql

# from LazyDeveloperr.modules.sql import cust_filters_sql as filtersql
# import LazyDeveloperr.modules.sql.welcome_sql as welcsql
import LazyDeveloperr.modules.sql.locks_sql as locksql
import LazyDeveloperr.modules.sql.notes_sql as sql

# from LazyDeveloperr.modules.rules import get_rules
import LazyDeveloperr.modules.sql.rules_sql as rulessql
from LazyDeveloperr import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from LazyDeveloperr.__main__ import DATA_IMPORT
from LazyDeveloperr.modules.connection import connected
from LazyDeveloperr.modules.helper_funcs.alternate import typing_action
from LazyDeveloperr.modules.helper_funcs.chat_status import user_admin
from LazyDeveloperr.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("LazyDeveloperr{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("LazyDeveloperr{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `LazyDeveloperr-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("LazyDeveloperr{}.backup".format(chat_id))  # Cleaning file
