...
import LazyDeveloperr.modules.sql.global_bans_sql as gban_sql
import LazyDeveloperr.modules.sql.users_sql as user_sql
from LazyDeveloperr import DEV_USERS, OWNER_ID, dispatcher
